...
/**
 * Created by yangyang on 2016/1/29.
 */
public class MarketJobDomain
{
    //唯一
    private Integer id;
    ...
    private String marketAreaIds;

    private String marketAreaNames;
    ...
    public String getMarketAreaIds()
    {
        return marketAreaIds;
    }

    public void setMarketAreaIds(String marketAreaIds)
    {
        this.marketAreaIds = marketAreaIds;
    }

    public String getMarketAreaNames()
    {
        return marketAreaNames;
    }

    public void setMarketAreaNames(String marketAreaNames)
    {
        this.marketAreaNames = marketAreaNames;
    }
    ...
    public String getScenePilotName()
    {
        return scenePilotName;
    }

    public void setScenePilotName(String scenePilotName)
    {
        this.scenePilotName = scenePilotName;
    }
