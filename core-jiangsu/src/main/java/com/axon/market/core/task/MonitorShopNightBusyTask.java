 ...
 */
public class MonitorShopNightBusyTask extends RunJob
{
    private static final Logger LOG = Logger.getLogger(MonitorShopNightBusyTask.class.getName());
    ...
    public void runBody()
    {
        ...
        {
            ThreadPoolUtil.submit(new ShopTaskExecutor(domain,7));
        }
    }
}
